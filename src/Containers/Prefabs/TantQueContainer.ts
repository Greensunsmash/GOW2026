...
export class TantQueContainer extends StructureContainer {
    ...
    constructor(l:ListContainer, root: GUI.Container, content_root:GUI.Container, scene: GameScene) {
        super(l, new InstructionContainer(["Tant que", "b", "est vrai, faire"], "while", root, content_root, scene, false), new InstructionContainer(["Fin"], undefined, root, content_root, scene, false));
    }
