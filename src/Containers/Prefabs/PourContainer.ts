...
export class PourContainer extends StructureContainer {
    ...
    constructor(l:ListContainer, root: GUI.Container, content_root:GUI.Container, scene: GameScene) {
        super(l, new InstructionContainer(["Répéter ", "v", " fois"], "for", root, content_root, scene, false), new InstructionContainer(["Fin"], undefined, root, content_root, scene, false));
    }
